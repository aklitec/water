 ...
 */
final class Version20191230123021 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client ADD CONSTRAINT FK_C7440455D17C3821 FOREIGN KEY (consumption_id) REFERENCES consumption (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
