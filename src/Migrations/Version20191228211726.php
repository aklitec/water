 ...
 */
final class Version20191228211726 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE bill (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(50) NOT NULL, print_date DATETIME NOT NULL, cost NUMERIC(10, 2) NOT NULL, status TINYINT(1) NOT NULL, released TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted TINYINT(1) NOT NULL, consumption INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
